{ config, vars, ... }:
let directories = [ "${vars.serviceConfigRoot}/timetagger" ];
in {
  ...
  virtualisation.oci-containers = {
    containers = {
      timetagger = {
        ...
        volumes = [ "${vars.serviceConfigRoot}/timetagger:/opt/_timetagger" ];
        environment = {
          TIMETAGGER_BIND = "0.0.0.0:80";
          TIMETAGGER_DATADIR = "/opt/_timetagger";
          TIMETAGGER_LOG_LEVEL = "info";
          TIMETAGGER_CREDENTIALS =
            "test:$2y$10$Dx3.YyZPmQepWfNoiK6Jpe1vo6XPaT7Q34IKmR4hvBO24gTf1GFAW";
        };
      };
    };
  };
